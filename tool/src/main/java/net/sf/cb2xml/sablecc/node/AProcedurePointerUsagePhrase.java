...
public final class AProcedurePointerUsagePhrase extends PUsagePhrase
{
    ...
    public AProcedurePointerUsagePhrase (TProcedurePointer _procedurePointer_)
    {
    ...
    public Object clone ()
    {
        return new AProcedurePointerUsagePhrase((TProcedurePointer) cloneNode (
                _procedurePointer_));
    }
    ...
    {
        return "" + toString (_procedurePointer_);
    }
