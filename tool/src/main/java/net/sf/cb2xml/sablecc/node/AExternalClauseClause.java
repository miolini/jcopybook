...
public final class AExternalClauseClause extends PClause
{
    ...
    public AExternalClauseClause (PExternalClause _externalClause_)
    {
    ...
    public Object clone ()
    {
        return new AExternalClauseClause((PExternalClause) cloneNode (
                _externalClause_));
    }
    ...
    {
        return "" + toString (_externalClause_);
    }
