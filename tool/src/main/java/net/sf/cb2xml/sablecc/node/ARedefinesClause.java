...
public final class ARedefinesClause extends PRedefinesClause
{
    ...
    public ARedefinesClause (TRedefines _redefines_, TDataName _dataName_)
    {
    ...
    public Object clone ()
    {
        return new ARedefinesClause((TRedefines) cloneNode (_redefines_),
    ...
    {
        return "" + toString (_redefines_) + toString (_dataName_);
    }
