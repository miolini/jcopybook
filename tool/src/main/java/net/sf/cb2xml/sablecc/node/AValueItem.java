...
public final class AValueItem extends PValueItem
{
    ...
    public AValueItem (TNumber88 _number88_, TDataName _dataName_,
        PValueOrValues _valueOrValues_, PLiteralSequence _literalSequence_)
    {
    ...
    public Object clone ()
    {
        return new AValueItem((TNumber88) cloneNode (_number88_),
    ...
    {
        return "" + toString (_number88_) + toString (_dataName_) +
        toString (_valueOrValues_) + toString (_literalSequence_);
    }
