...
public final class AJustifiedClauseClause extends PClause
{
    ...
    public AJustifiedClauseClause (PJustifiedClause _justifiedClause_)
    {
    ...
    public Object clone ()
    {
        return new AJustifiedClauseClause((PJustifiedClause) cloneNode (
                _justifiedClause_));
    }
    ...
    {
        return "" + toString (_justifiedClause_);
    }
