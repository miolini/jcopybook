...
public final class AFunctionPointerUsagePhrase extends PUsagePhrase
{
    ...
    public AFunctionPointerUsagePhrase (TFunctionPointer _functionPointer_)
    {
    ...
    public Object clone ()
    {
        return new AFunctionPointerUsagePhrase((TFunctionPointer) cloneNode (
                _functionPointer_));
    }
    ...
    {
        return "" + toString (_functionPointer_);
    }
