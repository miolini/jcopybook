...
public final class ADisplayUsagePhrase extends PUsagePhrase
{
    ...
    public ADisplayUsagePhrase (TDisplay _display_, TNative _native_)
    {
    ...
    public Object clone ()
    {
        return new ADisplayUsagePhrase((TDisplay) cloneNode (_display_),
    ...
    {
        return "" + toString (_display_) + toString (_native_);
    }
